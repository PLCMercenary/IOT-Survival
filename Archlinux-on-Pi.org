...
- [[#install-bootloader-and-os][Install Bootloader and OS]]
  - [[#pinn-is-a-bottled-that-will-allow-ssh-and-vnc-at-boot-time][PINN is a bottled that will allow SSH and VNC at boot time]]
...
:END:
** PINN is a bottled that will allow SSH and VNC at boot time
:PROPERTIES:
:CREATED:  [2020-03-06 Fri 19:45]
:END:
